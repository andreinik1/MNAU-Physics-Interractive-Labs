  ...
  return (
    <div className={styles.inputCard} style={{ marginBottom: "30px" }}>
      ...
      <p style={{ margin: "0 0 0 28px" }}>
        ...
        2. Зафіксувати різницю рівнів рідини в манометрі відпустивши ручку сифона і зняти покази <LaTeXFormula math="h_1" />, яке відповідає цій різниці.<br />
        ...
        4. Під'єднати трубку до сифона і після встановлення рівня рідини в манометрі, зняти показники <LaTeXFormula math="h_2" />, яке відповідає цій різниці.<br />

        5. Дослід повторити 3 рази. Дані внести до таблиці.<br />

        6. Значення <LaTeXFormula math="\gamma" /> знаходиться за формулою (13) для кожного досліду окремо:
        <LaTeXFormula math="\gamma = \frac{h_1}{h_1 - h_2}" block={true} />

        7. Знайти похибку для кожного досліду, кінцевий результат записати у вигляді:
        <LaTeXFormula math="\gamma = \gamma_{\text{сер}} \pm \Delta \gamma_{\text{сер}}" block={true} />
      </p>
